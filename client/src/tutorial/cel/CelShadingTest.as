package tutorial.cel
{
	...
	public class CelShadingTest extends Sprite
	{
		...
		[Embed(source="../assets/obj/testbox.obj", mimeType="application/octet-stream")]
		...
		private function onResourceRetrieved(ev : LoaderEvent) : void
		{
			...
			var lp:StaticLightPicker = new StaticLightPicker([ _light3 ]);
			material.lightPicker = lp;
