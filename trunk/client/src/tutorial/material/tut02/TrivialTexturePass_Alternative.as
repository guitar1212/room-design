package tutorial.material.tut02
{
	...
	/**
	 * TrivialTexturePass_Alternative is a pass rendering an unshaded texture.
	 * It is different from TrivialTexturePass_Alternative in that instead of cleaning up its own render state, it
	 * allows MaterialPassBase to handle this by setting the _numUsedStreams and _numUsedTextures properties
	 */
	public class TrivialTexturePass_Alternative extends MaterialPassBase
	{
		...
		{
			// don't need to clear anything ourselves
